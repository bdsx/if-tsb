        ...
        if (moduleinfo.kind === ts.ScriptKind.JSON) {
            ...
            if (useFileName || useDirName) {
                ...
                if (useFileName) {
                    ...
                    refined.content += `${prefix}__filename=${
                        bundler.globalVarName
                ...
                if (useDirName) {
                    ...
                    if (path.sep !== "/")
                        rpath = rpath.split(path.sep).join("/");
                    refined.content += `${prefix}__dirname=${
                        bundler.globalVarName
                    }.__resolve(${JSON.stringify(rpath)});\n`;
                    helper.addExternalList(
                        "path",
            ...
            if (this.isEntry) {
                ...
                if (useModuleExports)
                    refined.content += `return ${bundler.globalVarName}.${refined.id.varName}.exports=module.exports;\n`;
